...
import com.eventhub.services.converter.EventDTOMapper;
...
public class EventController {
    ...
    public ResponseEntity<EventDTO> createEvent(@RequestBody @Valid EventRequestDto eventRequestDto) {
        EventDTO event = eventService.createEvent(eventRequestDto);
    ...
    public ResponseEntity<EventDTO> updateEvent(@PathVariable("id") Long id,
        ...
        EventDTO event = eventService.updateEvent(id, eventRequestDto);
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(event);
    }
    ...
    public ResponseEntity<Void> registrationEvent(@PathVariable("id") Long id) {
        eventService.registrationEvent(id);
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .build();
    }
    ...
    public ResponseEntity<List<EventDTO>> getMyRegistrationEvents() {
        List<EventDTO> events = eventService.getMyRegistrationEvents();
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(events);
    }
    ...
    public ResponseEntity<Void> deleteRegistrationEvent(@PathVariable("id") Long id) {
        eventService.deleteRegistrationEvent(id);
        return ResponseEntity
                .status(HttpStatus.NO_CONTENT)
                .build();
    }
