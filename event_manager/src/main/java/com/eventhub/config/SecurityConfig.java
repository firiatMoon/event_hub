    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers(HttpMethod.POST, "/users/auth", "/users", "/pass/*").permitAll();
//                    auth.requestMatchers("/telegram/**", "/internal/telegram/**").permitAll();
                    auth.requestMatchers(HttpMethod.GET, "/telegram/**", "/internal/telegram/**").permitAll();
